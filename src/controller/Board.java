...
public class Board {
	...
	public void createFields() {
		...
		Street[] streets = new Street[] {
			...
			new Street(9, "AllÃ©gade", null, Group.PINK, 2400, new int[] {150, 800, 2000, 6000, 9000, 12000}, 1000),
			new Street(11, "Frederiksberg AllÃ©", null, Group.LIGHTGREEN, 2800, new int[] {200, 1000, 3000, 9000, 12500, 15000}, 2000),
			new Street(13, "BÃ¼lowsvej", null, Group.LIGHTGREEN, 2800, new int[] {200, 1000, 3000, 9000, 12500, 15000}, 2000),
			...
			new Street(23, "Ã˜sterbrogade", null, Group.RED, 4400, new int[] {350, 1800, 5000, 14000, 17500, 21000}, 3000),
			...
			new Street(29, "Ã˜stergade", null, Group.WHITE, 5600, new int[] {500, 2400, 7200, 17000, 20500, 24000}, 3000),

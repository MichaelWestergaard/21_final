...
public class Board {
	...
	public void createFields() {
		...
		Street[] streets = new Street[] {
			...
			new Street(11, "Frederiksberg All�", null, Group.LIGHTGREEN, 2800, new int[] {200, 1000, 3000, 9000, 12500, 15000}, 2000),
			new Street(13, "Bølowsvej", null, Group.LIGHTGREEN, 2800, new int[] {200, 1000, 3000, 9000, 12500, 15000}, 2000),
			...
			new Street(24, "Gr�nningen", null, Group.RED, 4800, new int[] {400, 2000, 6000, 15000, 18500, 22000}, 3000),
		...
		//S�tter alle ejendomme ind i fields[]
		...
		//S�tter alle pr�v lykken felter ind i fields[]
